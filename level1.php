...
<head>
    ...
    <title>MathVenture - Level 1 Penjumlahan Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 1: Penjumlahan</div>
...
<script>
        // Data Soal Level 1 (Penjumlahan)
        const level1Questions = [
            { question: "Hitung 3 + 2 =", answer: 5, options: [5, 4, 3, 2] },
            { question: "Hitung 1 + 3 + 4 =", answer: 8, options: [7, 8, 9, 11] },
            { question: "Hitung 5 + 2 + 4 + 2 =", answer: 13, options: [11, 12, 10, 13] }
        ];
        ...
        function levelComplete() {
            questionText.textContent = "Level 1 Selesai! 🎉";
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level1Questions.length - 1;
            if (!isLastQuestion) {
