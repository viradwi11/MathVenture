...
<head>
    ...
    <title>MathVenture - Level 6 Pengurangan Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 6: Pengurangan</div>
...
<script>
        ...
        const level6Questions = [
           {question: "Dito memiliki 9 balon. Tiga balon pecah terkena panas. Berapa balon yang masih dimiliki Dito?",answer: 6,options: [5, 6, 3, 8]},
           {question: "Sebuah kebun memiliki 120 mangga yang siap dipetik. Hari ini, 45 mangga dipetik petani. Berapa mangga yang masih ada di kebun?",answer: 75,options: [75, 65, 55, 85]},
           {question: "Perpustakaan sekolah memiliki 70 buku baru. Kemudian mendapat tambahan 28 buku donasi. Namun, 46 buku dipinjam siswa. Berapa buku yang masih ada?",answer: 52,options: [42, 52, 48, 63]}
        ];

        // 📍 KONFIGURASI
        const MAP_URL = 'http://localhost/mathventure/pagepeta.php'; 
        const USER_ID = <?php echo json_encode($user_id); ?>; 
        const CURRENT_LEVEL_ID = 6;
        ...
        function levelComplete() {
            questionText.textContent = "Level 6 Selesai! 🎉";
		...
		function unlockNextLevel() {
			...
			.then(r => r.json())
			.then(d => console.log("Unlock Level 7:", d));
		}
        ...
        function displayQuestion() {
            if (currentQuestionIndex >= level6Questions.length) {
                levelComplete();
                return;
            }
            // ... (Logika display soal lainnya) ...
            const currentQuestion = level6Questions[currentQuestionIndex];
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level6Questions.length - 1;
            if (!isLastQuestion) {
