...
<head>
    ...
    <title>MathVenture - Level 11 Pembagian Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 11: Pembagian</div>
...
<script>
        ...
        const level11Questions = [
            {question: "Hitung 72 ÷ 3 =",answer: 24,options: [24, 25, 26, 22]},
            {question: "Hitung 144 ÷ 12 =",answer: 12,options: [14, 12, 15, 16]},
            {question: "Hitung 80 ÷ 4 + 50 =",answer: 70,options: [60, 80, 90, 70]}
        ];
        // 📍 KONFIGURASI
        const MAP_URL = 'http://localhost/mathventure/pagepeta.php'; 
        const USER_ID = <?php echo json_encode($user_id); ?>; 
        const CURRENT_LEVEL_ID = 11;
        ...
        function levelComplete() {
            questionText.textContent = "Level 11 Selesai! 🎉";
		...
		function unlockNextLevel() {
			...
			.then(r => r.json())
			.then(d => console.log("Unlock Level 12:", d));
		}
        ...
        function displayQuestion() {
            if (currentQuestionIndex >= level11Questions.length) {
                levelComplete();
                return;
            }
            // ... (Logika display soal lainnya) ...
            const currentQuestion = level11Questions[currentQuestionIndex];
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level11Questions.length - 1;
            if (!isLastQuestion) {
