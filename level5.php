...
<head>
    ...
    <title>MathVenture - Level 5 Pengurangan Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 5: Pengurangan</div>
...
<script>
        ...
        const level5Questions = [
           {question: "Hitung 60 - 32 =",answer: 28,options: [27, 28, 30, 13]},
           {question: "Hitung 47 - 52 =",answer: -5,options: [-5, 6, 5, -4]},
           {question: "Hitung 22 - 10 + 51 =",answer: 63,options: [62, 80, 63, 70]}
        ];

        // 📍 KONFIGURASI
        const MAP_URL = 'http://localhost/mathventure/pagepeta.php'; 
        const USER_ID = <?php echo json_encode($user_id); ?>; 
        const CURRENT_LEVEL_ID = 5;
        ...
        function levelComplete() {
            questionText.textContent = "Level 5 Selesai! 🎉";
		...
		function unlockNextLevel() {
			...
			.then(r => r.json())
			.then(d => console.log("Unlock Level 6:", d));
		}
        ...
        function displayQuestion() {
            if (currentQuestionIndex >= level5Questions.length) {
                levelComplete();
                return;
            }
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level5Questions.length - 1;
            if (!isLastQuestion) {
