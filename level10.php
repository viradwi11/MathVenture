...
<head>
    ...
    <title>MathVenture - Level 10 Pembagian Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 10: Pembagian</div>
...
<script>
        ...
        const level10Questions = [
            {question: "Hitung 6 ÷ 3 =",answer: 2,options: [3, 4, 5, 2]},
            {question: "Hitung 30 ÷ 5 =",answer: 6,options: [5, 7, 6, 8]},
            {question: "Hitung 40 ÷ 10 - 10 =",answer: -6,options: [15, -7, 11, -6]}
        ];
        // 📍 KONFIGURASI
        const MAP_URL = 'http://localhost/mathventure/pagepeta.php'; 
        const USER_ID = <?php echo json_encode($user_id); ?>; 
        const CURRENT_LEVEL_ID = 10;
        ...
        function levelComplete() {
            questionText.textContent = "Level 10 Selesai! 🎉";
		...
		function unlockNextLevel() {
			...
			.then(r => r.json())
			.then(d => console.log("Unlock Level 11:", d));
		}
        ...
        function displayQuestion() {
            if (currentQuestionIndex >= level10Questions.length) {
                levelComplete();
                return;
            }
            // ... (Logika display soal lainnya) ...
            const currentQuestion = level10Questions[currentQuestionIndex];
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level10Questions.length - 1;
            if (!isLastQuestion) {
