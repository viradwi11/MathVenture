...
<head>
    ...
    <title>MathVenture - Level 8 Perkalian Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 8: Perkalian</div>
...
<script>
        ...
        const level8Questions = [
           {question: "Hitung 10 × 14 =",answer: 140,options: [170, 140, 168, 139]},
           {question: "Hitung 16 × 17 =",answer: 272,options: [272, 260, 230, 100]},
           {question: "Hitung 20 × 10 - 40 =",answer: 160,options: [150, 190, 160, 170]}
        ];
        // 📍 KONFIGURASI
        const MAP_URL = 'http://localhost/mathventure/pagepeta.php'; 
        const USER_ID = <?php echo json_encode($user_id); ?>; 
        const CURRENT_LEVEL_ID = 8;
        ...
        function levelComplete() {
            questionText.textContent = "Level 8 Selesai! 🎉";
		...
		function unlockNextLevel() {
			...
			.then(r => r.json())
			.then(d => console.log("Unlock Level 9:", d));
		}
        ...
        function displayQuestion() {
            if (currentQuestionIndex >= level8Questions.length) {
                levelComplete();
                return;
            }
            // ... (Logika display soal lainnya) ...
            const currentQuestion = level8Questions[currentQuestionIndex];
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level8Questions.length - 1;
            if (!isLastQuestion) {
