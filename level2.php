...
<head>
    ...
    <title>MathVenture - Level 2 Penjumlahan Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 2: Penjumlahan</div>
...
<script>
        ...
        const level2Questions = [
            {question: "Hitung 11 + 14 =",answer: 25,options: [23, 25, 30, 42]},
            {question: "Hitung 10 + 22 + 15 =",answer: 47,options: [47, 39, 45, 42]},
            {question:"Hitung 20 + 10 + 14 + 16 =",answer: 60,options: [49, 40, 60, 50]}
        ...
        function levelComplete() {
            questionText.textContent = "Level  Selesai! 🎉";
		...
		function unlockNextLevel() {
			const formData = new URLSearchParams();
			formData.append('user_id', USER_ID);
			formData.append('level_id', 3);
			formData.append('stars', 0); // Level baru selalu mulai dari 0 bintang
			...
			.then(r => r.json())
			.then(d => console.log("Unlock Level 2:", d));
		}
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level2Questions.length - 1;
            if (!isLastQuestion) {
