...
<head>
    ...
    <title>MathVenture - Level 7 Perkalian Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 7: Perkalian</div>
...
<script>
        ...
        const level7Questions = [
           {question: "Hitung 8 × 7 =",answer: 56,options: [54, 56, 42, 52]},
           {question: "Hitung 5 × 6 + 15 =",answer: 45,options: [35, 40, 50, 45]},
           {question: "Hitung 11 × 9 =",answer: 99,options: [90, 111, 99, 139]}
        ];

        // 📍 KONFIGURASI
        const MAP_URL = 'http://localhost/mathventure/pagepeta.php'; 
        const USER_ID = <?php echo json_encode($user_id); ?>; 
        const CURRENT_LEVEL_ID = 7;
        ...
        function levelComplete() {
            questionText.textContent = "Level 7 Selesai! 🎉";
		...
		function unlockNextLevel() {
			...
			.then(r => r.json())
			.then(d => console.log("Unlock Level 8:", d));
		}
        ...
        function displayQuestion() {
            if (currentQuestionIndex >= level7Questions.length) {
                levelComplete();
                return;
            }
            // ... (Logika display soal lainnya) ...
            const currentQuestion = level7Questions[currentQuestionIndex];
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level7Questions.length - 1;
            if (!isLastQuestion) {
