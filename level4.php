...
<head>
    ...
    <title>MathVenture - Level 4 Pengurangan Warna Warni</title>
...
<body>
    ...
    <div class="container">
        ...
        <h1>MathVenture</h1>
        <div class="level-info">Level 4: Pengurangan</div>
...
<script>
        ...
        const level4Questions = [
            {question: "Hitung 6 - 3 =",answer: 3,options: [4, 3, 5, 2]},
            {question: "Hitung 4 - 6 =",answer: -2,options: [2, -2, 3, -3]},
            {question: "Hitung 8 - 3 + 5 =",answer: 10,options: [7, 9, 10, 11]}
        ];
        ...
        function levelComplete() {
            questionText.textContent = "Level 4 Selesai! 🎉";
		...
		function unlockNextLevel() {
			...
			.then(r => r.json())
			.then(d => console.log("Unlock Level 5:", d));
		}
        ...
        function checkAnswer(selectedOption, correctAnswer, clickedButton) {
            ...
            const isLastQuestion = currentQuestionIndex === level4Questions.length - 1;
            if (!isLastQuestion) {
